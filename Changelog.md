...
## [0.2.3] - 2026-06-29
- added distance limit to editor notes
- added better color getting and hdr color field to animatables
- animatables now support range and float shader propeties
- pool despawn now checks if the object is acutally valid

## [0.2.2] - 2025-12-07
- fixed bugged in editor note behaviour

## [0.2.1] - 2025-12-06
- added missing directory meta files

## [0.2.0] - 2025-12-06
- min and maxBy now return default TSource when used on empty list
- added Object Pooling feature

## [0.1.4] - 2025-12-05
- added Post Label Attribute - useful to denominate units etc
